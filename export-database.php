	...
	class MediaFile extends DjangoModel {
		...
		function init_fields( $blog, $item, $file_path) {
			$this->fields = array(
				...
				"region" => $blog->blog_id,
				"alt_text" => ( $item->alt_text ? $item->alt_text : $item->post_title ),
