  ...
  $.fn.hideseek = function(options) {
    ...
    return this.each(function() {
      ...
      $this.keyup(function(e) {
        ...
        // check if on site search is still active
        if($('body').hasClass('searchOnSite') != false) {
          ...
          var firstMark = $list.find('mark.highlight').first();
          firstMark.addClass('current');
          if(firstMark.length) {
            $('html, body').animate({
              scrollTop: firstMark.offset().top - 80
            }, 150);
          }
        }
