	...
	?>
 	...
 	<div id='major-publishing-actions'>  
		<div id='publishing-action'> 
			<a id='printable' href='<?php echo $EM_Event->get_bookings_url(); ?>'><?php _e('manage bookings','dbem')?></a><br />
			...
			<br /><a href='<?php echo EM_ADMIN_URL ."&amp;page=events-manager-bookings&action=export_csv&event_id=".$EM_Event->event_id ?>'><?php _e('export csv','dbem')?></a>
			<?php endif; ?>
