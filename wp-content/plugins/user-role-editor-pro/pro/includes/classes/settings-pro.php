...
class URE_Settings_Pro {    
    ...
    public static function ms_update() {
        ...
        if ($caps_access_restrict_for_simple_admin) {
            ...
            $caps_allowed_for_single_admin = $lib->filter_existing_caps_input('caps_allowed_for_single_admin');            
        } else {
...
// Additional user capabilities        
    ...
    public static function ms_show() {
        ...
        if ($caps_access_restrict_for_simple_admin) {  
            ...
            $html_caps_blocked_for_single_admin = $lib->build_html_caps_blocked_for_single_admin();
            $html_caps_allowed_for_single_admin = $lib->build_html_caps_allowed_for_single_admin();
        }
