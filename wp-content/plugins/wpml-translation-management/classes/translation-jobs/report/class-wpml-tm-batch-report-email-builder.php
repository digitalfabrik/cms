...
class WPML_TM_Batch_Report_Email_Builder {
	...
	/**
	 * @var WPML_TM_Batch_Report_Email_Template
	 */
	 ...
	 * @param WPML_TM_Batch_Report_Email_Template $email_template
	 */
	public function __construct( WPML_TM_Batch_Report $batch_report, WPML_TM_Batch_Report_Email_Template $email_template ) {
	...
	public function prepare_unassigned_jobs_emails( $batch_jobs ) {
		if ( array_key_exists( 0, $batch_jobs ) ) {
			...
			foreach ( $translators as $translator ) {
				...
				$render_jobs_list = $this->email_template->render_jobs_list( $unassigned_jobs, $translator_user->ID, $title );
